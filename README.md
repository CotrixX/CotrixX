...
- 🔭 I'm currently building web & mobile products for clients — check out [my portfolio](https://cgauttier.dev)

- 🛠️ Deploying & securing network infrastructure (Juniper, Fortinet, F5) for Orange France

- 🤖 Automating workflows with n8n and the Anthropic API
